...
print "<h1>Men&uacute;</h1>";

if ($_SESSION["admin"] == 1) {
	print "<a href='adm_menu.php'>Administrar</a>";
}

print "<p /><a href='mensajes.php' target='_blank'>Bandeja de Entrada</a>";
print "<p /><a href='#'>Mensajes Enviados</a>"; // NO IMPLEMENTADO
print "<p /><a href='envia_mensaje.php' target='_blank'>Enviar</a>";
