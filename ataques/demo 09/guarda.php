...
consulta(
"insert into envios_varios values ('" . mysqli_real_escape_string($conexion, $_POST["datos"]) . "')"
);

print "insert into envios_varios values ('" . mysqli_real_escape_string($conexion, $_POST["datos"]) . "')";
?>